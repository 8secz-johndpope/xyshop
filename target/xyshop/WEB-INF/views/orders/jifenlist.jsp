...
<!-- 				  <label style="padding-left: 10px; display: none;">订单类型:</label> -->
	<input type="hidden" id="js-choise-type" value="score" />
<!--               	<select class="form-control js-change-table-params" id="js-choise-type" style="width: 150px;display: none;"> -->
<!--              		<option value="score">积分兑换订单</option> -->
<!--              	</select> -->
					<input type="hidden" id="js-choise-payway" value="score" />
<!--              	<label style="padding-left: 10px; ">支付方式:</label> -->
<!--              	<select class="form-control js-change-table-params" id="js-choise-payway" style="width: 150px;"> -->
<!--              		<option value="" selected="selected">全部</option> -->
    ...
    <div class="modal-content"> 
     ...
     <div class="modal-body">
     	...
     	<a class="list-group-item">
			...
			<input class="radio" type="radio" name="wuliu" value="HTKY"><label>百世快递</label>&nbsp;&nbsp;
			<input class="radio" type="radio" name="wuliu" value="YZPY"><label>邮政平邮</label>&nbsp;&nbsp;
			<input class="radio" type="radio" name="wuliu" value="EMS"><label>EMS</label>&nbsp;&nbsp;
			<input class="radio" type="radio" name="wuliu" value="HHTT"><label>天天快递</label>&nbsp;&nbsp;
			<input class="radio" type="radio" name="wuliu" value="JD"><label>京东快递</label>&nbsp;&nbsp;
			<input class="radio" type="radio" name="wuliu" value="QFKD"><label>全峰快递</label>&nbsp;&nbsp;
			<input class="radio" type="radio" name="wuliu" value="GTO"><label>国通快递</label>&nbsp;&nbsp;
			<input class="radio" type="radio" name="wuliu" value="UC"><label>优速快递</label>&nbsp;&nbsp;
			<input class="radio" type="radio" name="wuliu" value="DBL"><label>德邦快递</label>&nbsp;&nbsp;
			<input class="radio" type="radio" name="wuliu" value="ZJS"><label>宅急送</label>&nbsp;&nbsp;
			<input class="radio" type="radio" name="wuliu" value="ANE"><label>安能物流</label>&nbsp;&nbsp;
			<input class="radio" type="radio" name="wuliu" value="-1"><label>自提</label>&nbsp;&nbsp;
		</a>
     	<a class="list-group-item">
			<label>物流单号</label>
			<input class="form-control" type="text" id="p-wuliudanhao" placeholder="物流单号">
		</a>
